...
$(document).ready(function(){
    ...
    if (tam >= 768 ){
      ...
      $('.conteudo-topo .inferior .span8.busca-mobile').after(
        '<div class="login-top">'+
        '<a href="../conta/criar?next=conta_index&email=_"><span class="login-txt"><strong>Cadastrar</strong></span></a>'+
      '</div>'
      );
      ...
      $('.conteudo-topo .inferior .span8.busca-mobile').after(
        '<div class="atd-top">'+
        '<a href="../conta/login"><span class="atd-txt"><strong>Entrar</strong><span></a>'+
        '</div>'
      );
      $('#rodape .institucional').after($('#barraNewsletter'));
    ...
    $('#rodape > div:last-child .row-fluid > div:last-child a').before('<a href="https://montswork.webflow.io/" class="montswork" target="_blank"><img src="https://cdn.awsli.com.br/1041/1041512/arquivos/dev-by-monts.svg" alt="Monts.work"></a>');
    ...
    $('#cabecalho>.conteiner>.row-fluid>.span3').append(
    ...
    $('.info-principal-produto').prependTo($('.produto .span6 > .principal'));
